...
| **Upstream Release** | Push to `main`, every 15 min + manual | When upstream publishes a new GitHub Release, syncs, builds a **signed release APK**, and publishes a matching release on this fork |
